...
def test_helper_aload_sync_runs_from_sync_context(temp_project_root):
...
@pytest.mark.asyncio
async def test_helper_aload_sync_rejects_running_event_loop(temp_project_root):
...
@pytest.mark.asyncio
async def test_engine_bound_aload_sync_rejects_running_event_loop(temp_project_root):
...
def test_helper_aload_period_sync_uses_gateway_period_loader(tmp_path):
    class Base(DeclarativeBase):
        pass
...
def test_helper_asemi_join_sync_runs_from_sync_context(tmp_path):
    class Base(DeclarativeBase):
        pass
