...
def test_arrow_drop_duplicates_keeps_first_without_python_key_materialization_regression():
    table = pa.table(
        {
            "id": [1, 1, 2, 2],
            "group": ["a", "a", "b", "b"],
...
def test_arrow_drop_duplicates_keeps_last_without_python_key_materialization_regression():
    table = pa.table(
        {
            "id": [1, 1, 2, 2],
            "group": ["a", "a", "b", "b"],
